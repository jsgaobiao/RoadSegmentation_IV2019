...
PATH = '/home/gaobiao/Documents/RoadSegmentation_IV2019/results/1121_weaklabel_costmap/vis/'
NAME = '1121_weaklabel_costmap'
DATA_PATH = '/home/gaobiao/Documents/RoadSegmentation_IV2019/data/data_guilin_1121/'
...
videoWriter = cv2.VideoWriter(NAME+'.avi', cv2.cv.CV_FOURCC('M', 'J', 'P', 'G'), 10, (IMAGE_WIDTH * 3, IMAGE_HEIGHT * 2), True)
...
for i in range(len(imgList)):
    ...
    # colorizedImg = cv2.applyColorMap(costMap, cv2.COLORMAP_RAINBOW)
