...
tf.flags.DEFINE_string("result_log", "../../results/1120_costmap/result.log", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1104_baseline_rotate/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1120_costmap/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1120_costmap/vis_train/", "path to save results of visualization")
            ...
            for i in range(IMAGE_HEIGHT):
                for j in range(IMAGE_WIDTH):
                    if (test_images[0, i, j, 0] != 0):
                        ...
                        # print(i, j, costMap[0, i, j, 1], costMap[0, i, j, 2], costImg[i, j])
            print(str(itr) + '/' + str(len(test_records) - 1))
