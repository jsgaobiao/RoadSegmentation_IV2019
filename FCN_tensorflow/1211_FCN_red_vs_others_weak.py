...
import datetime
import BatchDatsetReader_weak as dataset
import pdb
from six.moves import xrange

FLAGS = tf.flags.FLAGS
tf.flags.DEFINE_string("result_log", "../../results/1211_red_vs_others_weak/result.txt", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1211_red_vs_others_weak/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1211_red_vs_others_weak/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1211_red_vs_others_weak/vis_train/", "path to save results of visualization")
...
prob_log = "../../results/1211_red_vs_others_weak/prob.txt"
    ...
    if FLAGS.mode == "train":
        ...
        for itr in xrange(MAX_ITERATION):
            ...
            if (itr % 500 == 0):
                ...
                test_images, test_annotations, test_weak_annotations = test_dataset_reader.next_batch_weak(FLAGS.batch_size, random_rotate = 0)
