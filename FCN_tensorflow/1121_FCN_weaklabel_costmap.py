...
tf.flags.DEFINE_string("result_log", "../../results/1121_weaklabel_costmap/result.log", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1107_weaklabel_rotate_weight1000/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1121_weaklabel_costmap/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1121_weaklabel_costmap/vis_train/", "path to save results of visualization")
tf.flags.DEFINE_string("data_dir", "../../data/data_guilin_1121/", "path to dataset")
