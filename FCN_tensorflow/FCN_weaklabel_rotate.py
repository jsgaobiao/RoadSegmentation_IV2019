...
tf.flags.DEFINE_string("result_log", "../../results/1108_weaklabel_rotate/result.log", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1108_weaklabel_rotate/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1108_weaklabel_rotate/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1108_weaklabel_rotate/vis_train/", "path to save results of visualization")
tf.flags.DEFINE_string("data_dir", "../../data/data_weak_4L/", "path to dataset")
...
def main(argv=None):
    ...
    # Calculate loss
    class_weights = tf.constant([10.0,  500.0,  500.0, 0.0])
