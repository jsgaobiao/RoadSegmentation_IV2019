...
tf.flags.DEFINE_string("result_log", "../../results/1216_2label_weak/result.txt", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1216_2label_weak/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1216_2label_weak/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1216_2label_weak/vis_train/", "path to save results of visualization")
...
prob_log = "../../results/1216_2label_weak/prob.txt"
...
def main(argv=None):
    ...
    # Calculate loss
    class_weights = tf.constant([0.3,  5.0,  1.0])
