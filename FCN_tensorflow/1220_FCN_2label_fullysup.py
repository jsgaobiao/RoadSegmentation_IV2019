...
tf.flags.DEFINE_string("result_log", "../../results/1220_2label_fullysup/result.txt", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1220_2label_fullysup/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1220_2label_fullysup/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1220_2label_fullysup/vis_train/", "path to save results of visualization")
...
prob_log = "../../results/1220_2label_fullysup/prob.txt"
