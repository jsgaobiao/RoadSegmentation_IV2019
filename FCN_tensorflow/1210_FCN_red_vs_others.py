...
tf.flags.DEFINE_string("result_log", "../../results/1210_red_vs_others/result.txt", "path to mPA log")
tf.flags.DEFINE_integer("batch_size", "16", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "../../results/1210_red_vs_others/checkpoints/", "path to logs directory")
tf.flags.DEFINE_string("vis_dir",  "../../results/1210_red_vs_others/vis/", "path to save results of visualization")
tf.flags.DEFINE_string("vis_train_dir",  "../../results/1210_red_vs_others/vis_train/", "path to save results of visualization")
...
prob_log = "../../results/1210_red_vs_others/prob.txt"
